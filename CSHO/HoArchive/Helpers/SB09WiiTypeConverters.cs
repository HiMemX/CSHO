...
namespace HoArchive{
    ...
    public class SB09WiiStringPointerConverter: System.ComponentModel.ExpandableObjectConverter
    {
        public override bool GetPropertiesSupported(ITypeDescriptorContext context)
        {
            return false;
        ...
        public override object ConvertFrom( System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value )
        {
            return new SB09WiiAsset.Pointer32_string((string)value);
        }

        public override object ConvertTo( System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destinationType )
        {
            return ((SB09WiiAsset.Pointer32_string)value).str;
        }
    }
    ...
    public class SB09WiiSoundIndicesPointerConverter: System.ComponentModel.ExpandableObjectConverter
    {
        ...
        public override object ConvertFrom( System.ComponentModel.ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value )
        {
            ...
            if(tokens.Count == 0){return new SB09WiiAsset.Pointer32_soundIndices(new soundIndices());}
