...
namespace SB09WiiAsset{
    public class ChannelInfo{
        ...
        public RenderingInternal.ChannelInfo GetChannelInfo(){
            RenderingInternal.ChannelInfo output = new RenderingInternal.ChannelInfo();

            output.vfrac = vfrac;
            output.vindex = vindex;
            output.voffset = voffset;
            output.vstride = vstride;
            output.vtype = vtype;
