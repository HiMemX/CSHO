...
class BinaryWriterEndian : BinaryWriter{
    bool endianness; // 0: big, 1: little
    public BinaryWriterEndian(string path, bool endian) : base(new FileStream(path, FileMode.OpenOrCreate)){
        endianness = endian;
    }
